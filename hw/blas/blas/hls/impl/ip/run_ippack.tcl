...
set IPName      "sgemm"
set Version     "1.0"
set DisplayName "Sgemm"
set Revision    "2113670262"
...
set xo_kernel_name "sgemm"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/media/p4/Xilinx/kria-vitis-platforms/kr260/platforms/xilinx_kr260_tsn_rs485pmod_202310_1/blas/blas/hls"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/media/p4/Xilinx/kria-vitis-platforms/kr260/platforms/xilinx_kr260_tsn_rs485pmod_202310_1/blas/blas/hls/.debug"
set xo_hls_files_dir ""
set hdl_module_list {sgemm_flow_control_loop_pipe_sequential_init
...
sgemm_flow_control_loop_pipe_sequential_init
...
set kernel_xo ""
set detect_deadlock_json "sgemm_message_dict.json"

## Variables
set Top "sgemm"
set TopNoPrefix "sgemm"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 k W 0x0 "Data signal of k" {{0 32 k W 0 "Bit 31 to 0 of k"}}} {0x18 A_offset_1 W 0x0 "Data signal of A_offset" {{0 32 A_offset W 0 "Bit 31 to 0 of A_offset"}}} {0x1c A_offset_2 W 0x0 "Data signal of A_offset" {{0 32 A_offset W 0 "Bit 63 to 32 of A_offset"}}} {0x24 lda_1 W 0x0 "Data signal of lda" {{0 32 lda W 0 "Bit 31 to 0 of lda"}}} {0x28 lda_2 W 0x0 "Data signal of lda" {{0 32 lda W 0 "Bit 63 to 32 of lda"}}} {0x30 B_offset_1 W 0x0 "Data signal of B_offset" {{0 32 B_offset W 0 "Bit 31 to 0 of B_offset"}}} {0x34 B_offset_2 W 0x0 "Data signal of B_offset" {{0 32 B_offset W 0 "Bit 63 to 32 of B_offset"}}} {0x3c ldb_1 W 0x0 "Data signal of ldb" {{0 32 ldb W 0 "Bit 31 to 0 of ldb"}}} {0x40 ldb_2 W 0x0 "Data signal of ldb" {{0 32 ldb W 0 "Bit 63 to 32 of ldb"}}} {0x48 C_offset_1 W 0x0 "Data signal of C_offset" {{0 32 C_offset W 0 "Bit 31 to 0 of C_offset"}}} {0x4c C_offset_2 W 0x0 "Data signal of C_offset" {{0 32 C_offset W 0 "Bit 63 to 32 of C_offset"}}} {0x54 ldc_1 W 0x0 "Data signal of ldc" {{0 32 ldc W 0 "Bit 31 to 0 of ldc"}}} {0x58 ldc_2 W 0x0 "Data signal of ldc" {{0 32 ldc W 0 "Bit 63 to 32 of ldc"}}} {0x60 RM W 0x0 "Data signal of RM" {{0 8 RM W 0 "Bit 7 to 0 of RM"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 RN W 0x0 "Data signal of RN" {{0 8 RN W 0 "Bit 7 to 0 of RN"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 m0_1 W 0x0 "Data signal of m0" {{0 32 m0 W 0 "Bit 31 to 0 of m0"}}} {0x74 m0_2 W 0x0 "Data signal of m0" {{0 32 m0 W 0 "Bit 63 to 32 of m0"}}} {0x7c m_1 W 0x0 "Data signal of m" {{0 32 m W 0 "Bit 31 to 0 of m"}}} {0x80 m_2 W 0x0 "Data signal of m" {{0 32 m W 0 "Bit 63 to 32 of m"}}} {0x88 n0_1 W 0x0 "Data signal of n0" {{0 32 n0 W 0 "Bit 31 to 0 of n0"}}} {0x8c n0_2 W 0x0 "Data signal of n0" {{0 32 n0 W 0 "Bit 63 to 32 of n0"}}} {0x94 n_1 W 0x0 "Data signal of n" {{0 32 n W 0 "Bit 31 to 0 of n"}}} {0x98 n_2 W 0x0 "Data signal of n" {{0 32 n W 0 "Bit 63 to 32 of n"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_A m_axi_B m_axi_C"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 6410 II x}
...
source -notrace "/media/p4/Xilinx/Vitis_HLS/2023.2/common/scripts/ipxhls.tcl"
set outdir .
