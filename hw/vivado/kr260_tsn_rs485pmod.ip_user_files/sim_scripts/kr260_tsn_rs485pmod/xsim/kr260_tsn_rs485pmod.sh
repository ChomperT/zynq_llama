...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_15 -L zynq_ultra_ps_e_vip_v1_0_15 -L smartconnect_v1_0 -L ta_dma_v1_0_13 -L switch_core_top_v1_0_14 -L tsn_temac_v1_0_9 -L xilinx_vip"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/p4/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb kr260_tsn_rs485pmod.wdb xsim.dir libdpi.so)
